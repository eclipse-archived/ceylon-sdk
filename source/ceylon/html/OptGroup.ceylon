 ...
 ********************************************************************************/
"
 The __&lt;optgroup&gt;__ element creates a grouping of options within a &lt;select&gt; element.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-optgroup-element).
"
see(`class Option`)
shared class OptGroup(
    ...
    shared actual {Content<Option>*} children = [])
        extends Element("optgroup", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, 
