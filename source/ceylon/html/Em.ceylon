 ...
 ********************************************************************************/
"
 The __&lt;em&gt;__ element marks text that has stress emphasis.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-em-element).
"
...
shared class Em(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("em", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
