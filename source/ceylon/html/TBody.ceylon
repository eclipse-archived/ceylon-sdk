 ...
 ********************************************************************************/
"
 The __&lt;tbody&gt;__ element defines one or more tr element data-rows 
 to be the body of its parent table element.
 
 For example see [[table|Table]] element.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-tbody-element).
"
see(`class Table`)
tagged("tables")
shared class TBody(
    ...
    shared actual {Content<Tr>*} children = [])
        extends Element("tbody", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children) {
}