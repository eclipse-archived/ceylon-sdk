 ...
 ********************************************************************************/
"
 The __&lt;ins&gt;__ element represents a range of text that has been added to a document.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-ins-element).
"
...
shared class Ins(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("ins", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, 
