...
shared test void testDate() => assertEquals( date(2013, february, 13), feb_13_2013_18_00_42_0057.date(timeZone.utc) );
shared test void testTime() => assertEquals( time(18, 0, 42, 57), feb_13_2013_18_00_42_0057.time(timeZone.utc));

shared test void testPlusPeriod_UTC() {
...
shared test void testMinusPeriod_UTC() {
...
shared test void testDurationTo() {
...
shared test void testDurationFrom() {
    value twoDaysduration = ( 2 * milliseconds.perDay );
...
shared test void testEqualsAndHash() {
