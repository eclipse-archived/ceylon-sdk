 ...
 ********************************************************************************/
"
 The __&lt;footer&gt;__ element represents a footer for its nearest sectioning 
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-footer-element).
"
tagged("flow")
see(`class Header`)
shared class Footer(
    ...
    shared actual {Content<FlowCategory>*} children = [])
        extends Element("footer", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
