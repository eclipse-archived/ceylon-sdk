 ...
 ********************************************************************************/
"
 The __&lt;q&gt;__ indicates that the enclosed text is a short inline quotation. 
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-q-element).
"
...
shared class Q(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("q", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, 
