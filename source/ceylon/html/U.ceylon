 ...
 ********************************************************************************/
"
 The __&lt;u&gt;__ element renders text with an underline, a line under the baseline of its content.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-u-element).
"
...
shared class U(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("u", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
