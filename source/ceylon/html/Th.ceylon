 ...
 ********************************************************************************/
"
 The __&lt;th&gt;__ element defines a cell as a header for a group of cells of a table. 
 
 For example see [[table|Table]] element.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-th-element).
"
see(`class Table`)
tagged("tables")
shared class Th(
    ...
    "Attribute contains a non-negative integer value that indicates for how many columns the cell extends. Its default value is 1; if its value is set to 0, it extends until the end of the colgroup, even if implicitly defined, that the cell belongs to."
    Attribute<Integer> colspan = null,
    "Attribute contains a list of space-separated strings, each corresponding to the id attribute of the th elements that apply to this element."
    Attribute<String> headers = null,
    "Attribute contains a non-negative integer value that indicates for how many rows the cell extends. Its default value is 1; if its value is set to 0, it extends until the end of the table section."
    Attribute<Integer> rowspan = null,
    "Attribute defines the cells that the header defined in this th element relates to."
    Attribute<String> scope = null,
    "The attributes associated with this element."
    Attributes attributes = [],
    "The children of this element."
    shared actual {Content<FlowCategory>*} children = [])
        extends Element("th", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, 
                    [attributeEntry("colspan", colspan),
                     attributeEntry("headers", headers),
                     attributeEntry("rowspan", rowspan),
                     attributeEntry("scope", scope),
                    *attributes], children) {
