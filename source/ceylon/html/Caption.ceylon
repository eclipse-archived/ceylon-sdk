 ...
 ********************************************************************************/
"
 The __&lt;caption&gt;__ element represents the title of a table. Though it is 
 always the first descendant of a table, its styling, using CSS, may place it 
 elsewhere, relative to the table.
 
 For example see [[table|Table]] element.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-caption-element).
"
see(`class Table`)
tagged("tables")
shared class Caption(
    ...
    shared actual {Content<FlowCategory>*} children = [])
        extends Element("caption", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children) {
}