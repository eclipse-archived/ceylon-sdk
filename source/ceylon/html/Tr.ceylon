 ...
 ********************************************************************************/
"
 The __&lt;tr&gt;__ element represents table row, defines a row of cells in a table. 
 
 For example see [[table|Table]] element.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-tr-element).
"
see(`class Table`)
tagged("tables")
shared class Tr(
    ...
    shared actual {Content<Td|Th>*} children = [])
        extends Element("tr", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children) {
}