"Represent a summary result of the test run."
shared interface TestRunResult {
    ...
    "The number of tests that finish successfully."
    shared formal Integer successCount;

    "The number of tests that finish with failure."
    shared formal Integer failureCount;

    "The number of tests that finish with error."
    ...
    "The detailed results of each tests."
