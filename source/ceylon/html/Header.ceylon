 ...
 ********************************************************************************/
"
 The __&lt;header&gt;__ element represents a group of introductory or navigational aids. 
 It may contain some heading elements but also other elements like a logo, wrapped 
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-header-element).
"
tagged("flow")
see(`class Footer`)
shared class Header(
    ...
    shared actual {Content<FlowCategory>*} children = [])
        extends Element("header", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
