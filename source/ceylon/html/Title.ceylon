 ...
 ********************************************************************************/
"
 The __&lt;title&gt;__ element defines the title of the document, 
 shown in a browser's title bar or on the page's tab.
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/document-metadata.html#the-title-element).
 "
tagged("metadata")
shared class Title(
    ...
    shared actual {Content<String>*} children = [])
        extends Element("title", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
