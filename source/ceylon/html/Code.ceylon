 ...
 ********************************************************************************/
"
 The __&lt;code&gt;__ element represents a fragment of computer code. By default, 
 ...
 P {
     \"Regular text \", Code { \"this is code example\" }, \" regular text.\"  
 };
 </pre>
 ...
 &lt;p&gt;
 Regular text &lt;code&gt;this is code example&lt;/code&gt; regular text.
 &lt;/p&gt;
 </pre>
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-code-element).
"
...
shared class Code(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("code", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
