 ...
 ********************************************************************************/
"
 The __&lt;del&gt;__ element represents a range of text that has been deleted 
 from a document. This element is often (but need not be) rendered with strike-through text.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-del-element).
"
...
shared class Del(
    ...
    "Attribute specifies a URI for a resource that explains the change (for example, meeting minutes)."
    Attribute<String> cite = null,
    "Attribute indicates the time and date of the change."
    Attribute<String> datetime = null,
    "The attributes associated with this element."
    Attributes attributes = [],
    "The children of this element."
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("del", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, 
                    [attributeEntry("cite", cite),
