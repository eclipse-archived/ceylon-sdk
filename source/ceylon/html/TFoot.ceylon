 ...
 ********************************************************************************/
"
 The __&lt;tfoot&gt;__ element defines a set of rows summarizing the columns of the table.
 
 For example see [[table|Table]] element.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-tfoot-element).
"
see(`class Table`)
tagged("tables")
shared class TFoot(
    ...
    shared actual {Content<Tr>*} children = [])
        extends Element("tfoot", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children) {
}