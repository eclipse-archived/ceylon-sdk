...
"
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-s-element).
"
...
shared class S(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("s", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
