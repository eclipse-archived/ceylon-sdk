 ...
 ********************************************************************************/
"
 The __&lt;pre&gt;__ element represents a block of preformatted text, in which 
 ...
 Pre { attributes=[\"data-language\"->\"ceylon\"];
     \"\"\"
     void sayHi() {
         print(\"Hi!\");
     }
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-pre-element).
"
tagged("flow")
shared class Pre(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("pre", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
