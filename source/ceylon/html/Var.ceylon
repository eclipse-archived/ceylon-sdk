 ...
 ********************************************************************************/
"
 The __&lt;var&gt;__ element represents a variable in a mathematical expression or a programming context.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-var-element).
"
...
shared class Var(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("var", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
