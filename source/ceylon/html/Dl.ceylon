 ...
 ********************************************************************************/
"
 The __&lt;dl&gt;__ element encloses a list of pairs of terms and descriptions. 
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-dl-element).
"
see(`class Dt`, `class Dd`, `class Dfn`)
tagged("flow", "lists")
shared class Dl(
    ...
    shared actual {Content<Dt|Dd>*} children = [])
        extends Element("dl", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
