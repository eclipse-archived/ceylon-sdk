 ...
 ********************************************************************************/
"
 The __&lt;dd&gt;__ element indicates the description of a term in a description 
 list &lt;dl&gt; element. This element can occur only as a child element of a description 
 list and it must follow a &lt;dt&gt; element. 
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-dd-element).
"
see(`class Dl`)
tagged("lists")
shared class Dd(
    ...
    shared actual {Content<FlowCategory>*} children = [])
        extends Element("dd", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children) {
}