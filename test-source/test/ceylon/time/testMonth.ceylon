...
test void test_january_firstDayOfYear() => assertEquals(1, january.firstDayOfYear());
test void test_february_firstDayOfYear() => assertEquals(32, february.firstDayOfYear());
test void test_march_firstDayOfYear() => assertEquals(60, march.firstDayOfYear());
test void test_april_firstDayOfYear() => assertEquals(91, april.firstDayOfYear());
test void test_may_firstDayOfYear() => assertEquals(121, may.firstDayOfYear());
test void test_june_firstDayOfYear() => assertEquals(152, june.firstDayOfYear());
test void test_july_firstDayOfYear() => assertEquals(182, july.firstDayOfYear());
test void test_august_firstDayOfYear() => assertEquals(213, august.firstDayOfYear());
test void test_september_firstDayOfYear() => assertEquals(244, september.firstDayOfYear());
test void test_october_firstDayOfYear() => assertEquals(274, october.firstDayOfYear());
test void test_november_firstDayOfYear() => assertEquals(305, november.firstDayOfYear());
test void test_december_firstDayOfYear() => assertEquals(335, december.firstDayOfYear());

test void test_january_firstDayOfYear_leapYear() => assertEquals(1, january.firstDayOfYear(leapYear));
test void test_february_firstDayOfYear_leapYear() => assertEquals(32, february.firstDayOfYear(leapYear));
test void test_march_firstDayOfYear_leapYear() => assertEquals(61, march.firstDayOfYear(leapYear));
test void test_april_firstDayOfYear_leapYear() => assertEquals(92, april.firstDayOfYear(leapYear));
test void test_may_firstDayOfYear_leapYear() => assertEquals(122, may.firstDayOfYear(leapYear));
test void test_june_firstDayOfYear_leapYear() => assertEquals(153, june.firstDayOfYear(leapYear));
test void test_july_firstDayOfYear_leapYear() => assertEquals(183, july.firstDayOfYear(leapYear));
test void test_august_firstDayOfYear_leapYear() => assertEquals(214, august.firstDayOfYear(leapYear));
test void test_september_firstDayOfYear_leapYear() => assertEquals(245, september.firstDayOfYear(leapYear));
test void test_october_firstDayOfYear_leapYear() => assertEquals(275, october.firstDayOfYear(leapYear));
test void test_november_firstDayOfYear_leapYear() => assertEquals(306, november.firstDayOfYear(leapYear));
test void test_december_firstDayOfYear_leapYear() => assertEquals(336, december.firstDayOfYear(leapYear));
