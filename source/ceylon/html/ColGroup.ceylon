 ...
 ********************************************************************************/
"
 The __&lt;colgroup&gt;__ element defines a group of columns within a table.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-colgroup-element).
"
see(`class Table`, `class Col`)
tagged("tables")
shared class ColGroup(
    ...
    "Attribute contains a positive integer indicating the number of consecutive columns the col element spans. If not present, its default value is 1."
    Attribute<Integer> span = null,
    "The attributes associated with this element."
    Attributes attributes = [],
    "The children of this element."
    shared actual {Content<Col>*} children = [])
        extends Element("colgroup", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, [attributeEntry("span", span), *attributes], []) {
}