 ...
 ********************************************************************************/
"
 The __&lt;mark&gt;__ element represents highlighted text, i.e., a run of text 
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-mark-element).
"
...
shared class Mark(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("mark", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
