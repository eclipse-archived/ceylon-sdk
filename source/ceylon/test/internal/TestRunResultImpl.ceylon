...
class TestRunResultImpl() satisfies TestRunResult {
    ...
    shared object listener satisfies TestListener {
        ...
        shared actual void testRunStart(TestDescription description) => startTimeMilliseconds = process.milliseconds;

        shared actual void testRunFinish(TestRunResult result) => endTimeMilliseconds = process.milliseconds;
