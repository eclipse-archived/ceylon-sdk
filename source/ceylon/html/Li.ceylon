 ...
 ********************************************************************************/
"
 The __&lt;li&gt;__ element is used to represent an item in a list. It must be 
 ...
 using bullet points. In ordered lists, they are usually displayed with an ascending 
 counter on the left, such as a number or letter.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-li-element).
"
see(`class Ul`, `class Ol`)
tagged("lists")
shared class Li(
    ...
    shared actual {Content<FlowCategory>*} children = [])
        extends Element("li", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, 
            [attributeEntry("value", val), *attributes], children) {
}