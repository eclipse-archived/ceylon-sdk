 ...
 ********************************************************************************/
"
 The __&lt;legend&gt;__ element represents a caption for the content of its parent &lt;fieldset&gt;.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-legend-element).
"
see(`class FieldSet`)
shared class Legend(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("legend", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children) {
}