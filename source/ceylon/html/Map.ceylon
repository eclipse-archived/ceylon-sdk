 ...
 ********************************************************************************/
"
 The __&lt;map&gt;__ element is used with &lt;area&gt; elements 
 to define an image map (a clickable link area).
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-map-element).
"
...
shared class Map(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("map", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, 
