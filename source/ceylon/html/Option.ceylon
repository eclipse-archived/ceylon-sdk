 ...
 ********************************************************************************/
"
 The __&lt;option&gt;__ element is used to create a control representing an item 
 within a &lt;select&gt;, an &lt;optgroup&gt; or a &lt;datalist&gt; HTML5 element.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-option-element).
"
see(`class DataList`)
shared class Option(
    ...
    "Attribute if is set, this option is not checkable. Often browsers grey out such control and it won't receive any browsing event, like mouse clicks or focus-related ones."
    Attribute<Boolean> disabled = null,
    "Attribute is text for the label indicating the meaning of the option. If the label attribute isn't defined, its value is that of the element text content."
    Attribute<String> label = null,
    "Attribute indicates that the option is initially selected."
    Attribute<Boolean> selected = null,
    "Attribute specifies the machine-readable translation of the content of the element."
    Attribute<String> val = null,
    "The attributes associated with this element."
    Attributes attributes = [],
    "The children of this element."
    shared actual {Content<String>*} children = [])
        extends Element("option", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, 
