 ...
 ********************************************************************************/
"
 The __&lt;body&gt;__ element represents the content of an HTML document. 
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/sections.html#the-body-element).
 "
shared class Body(
    ...
    shared actual {Content<FlowCategory>*} children = [])
        extends Element("body", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children) {
}