 ...
 ********************************************************************************/
"
 The __&lt;time&gt;__ element represents either a time on a 24-hour clock or a 
 precise date in the Gregorian calendar (with optional time and timezone information).
 ...
 P {
     \"We open at \", Time { \"20:00\" }, \" every day.\" 
 };
 </pre>
 ...
 &lt;p&gt;
 We open at &lt;time&gt;20:20&lt;/time&gt; every day. 
 &lt;/p&gt;
 </pre>
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-time-element).
"
...
shared class Time(
    ...
    "attribute indicates the time and date of the element and must be a valid date with an optional time string. If the value cannot be parsed as a date with an optional time string, the element does not have an associated time stamp."
    Attribute<String> datetime = null,
    "The attributes associated with this element."
    Attributes attributes = [],
    "The children of this element."
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("time", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, 
                    [attributeEntry("datetime", datetime), 
                    *attributes], children)
