 ...
 ********************************************************************************/
"
 The __&lt;p&gt;__ element represents a paragraph of text. Paragraphs are usually 
 represented in visual media as blocks of text that are separated from adjacent 
 blocks by vertical blank space and/or first-line indentation. 
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-p-element).
"
tagged("flow")
shared class P(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("p", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
