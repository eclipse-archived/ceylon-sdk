 ...
 ********************************************************************************/
"
 The __&lt;datalist&gt;__ element contains a set of &lt;option&gt; elements 
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-datalist-element).
"
tagged("flow", "phrasing")
see(`class Option`)
shared class DataList(
    ...
    shared actual {Content<PhrasingCategory|Option>*} children = [])
        extends Element("datalist", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
