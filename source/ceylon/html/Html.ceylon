 ...
 ********************************************************************************/
"
 The __&lt;html&gt;__ element represents the root of an HTML document. 
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/sections.html#the-html-element).
 "
shared class Html(
    "The Document Type Definition (DTD) of the current document."
    shared Doctype doctype = Doctype.html5,
    ...
    "Attribute specifies the URI of a resource manifest indicating resources that should be cached locally."
    Attribute<String> manifest = null,
    "The attributes associated with this element."
    Attributes attributes = [],
    "The children of this element."
    shared actual {Head|Body*} children = [])
        extends Element("html", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, [attributeEntry("manifest", manifest), *attributes], children) {
}