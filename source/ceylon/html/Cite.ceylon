 ...
 ********************************************************************************/
"
 The __&lt;cite&gt;__ element epresents a reference to a creative work. It must 
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-cite-element).
"
...
shared class Cite(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("cite", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
