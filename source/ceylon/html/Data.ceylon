 ...
 ********************************************************************************/
"
 The __&lt;data&gt;__ element links a given content with a machine-readable 
 translation. If the content is time- or date-related, the &lt;time&gt; must be used.
 ...
 Ul {
     Li { Data { val = \"123-123-123\"; \"Milk\" }},
     Li { Data { val = \"456-456-456\"; \"Coffee\" }},
     ...
 };
 </pre>
 ...
 &lt;ul&gt;
     &lt;li&gt;&lt;data value=\"123-123-123\"&gt;Milk&lt;/data&gt;&lt;/li&gt;
     &lt;li&gt;&lt;data value=\"456-456-456\"&gt;Coffee&lt;/data&gt;&lt;/li&gt;
     ....
 &lt;/ul&gt;
 </pre>
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-data-element).
"
...
shared class Data(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("data", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, [attributeEntry("value", val), *attributes], children)
