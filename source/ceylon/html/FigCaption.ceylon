 ...
 ********************************************************************************/
"
 The __&lt;figcaption&gt;__ represents a caption or a legend associated with a &lt;figure&gt; element.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-figcaption-element).
"
see(`class Figure`)
shared class FigCaption(
    ...
    shared actual {Content<FlowCategory>*} children = [])
        extends Element("figcaption", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
