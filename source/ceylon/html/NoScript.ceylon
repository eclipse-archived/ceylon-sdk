 ...
 ********************************************************************************/
"
 The __&lt;noscript&gt;__ element defines a section of html to be inserted if a script 
 type on the page is unsupported or if scripting is currently turned off in the browser.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/document-metadata.html#the-noscript-element).
 "
tagged("metadata", "flow", "phrasing")
shared class NoScript(
    ...
    shared actual {Content<Link|Meta|Style|FlowCategory>*} children = [])
        extends Element("script", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
