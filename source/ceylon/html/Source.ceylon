 ...
 ********************************************************************************/
"
 The __&lt;source&gt;__ element specifies multiple media resources for either 
 the &lt;picture&gt;, the &lt;audio&gt; or the &lt;video&gt; element. It is 
 an empty element. It is commonly used to serve the same media content in multiple 
 formats supported by different browsers.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/document-metadata.html#the-source-element).
 "
...
shared class Source(
    ...
    "Attribute required for audio and video, address of the media resource. The value of this attribute is ignored when the source element is placed inside a picture element."
    Attribute<String> src = null,
    "Attribute specifies the MIME-type of the resource, optionally with a codecs parameter. See RFC 4281 for information about how to specify codecs."
    Attribute<String>|Attribute<MimeType> type = null,    
    "Attribute specifies media query of the resource's intended media; this should be used only in a picture element."
    Attribute<String> media = null,
    "The attributes associated with this element."
    Attributes attributes = [])
        extends Element("source", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, 
