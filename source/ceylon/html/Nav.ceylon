 ...
 ********************************************************************************/
"
 The __&lt;nav&gt;__ represents a section of a page that links to other pages 
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-nav-element).
"
tagged("flow")
shared class Nav(
    ...
    shared actual {Content<FlowCategory>*} children = [])
        extends Element("nav", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
