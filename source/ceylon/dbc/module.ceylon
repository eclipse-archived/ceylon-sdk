...
native("jvm")
module ceylon.dbc maven:"org.ceylon-lang" "**NEW_VERSION**-SNAPSHOT" {
    import ceylon.collection "**NEW_VERSION**-SNAPSHOT";
    shared import ceylon.decimal "**NEW_VERSION**-SNAPSHOT";
    shared import ceylon.whole "**NEW_VERSION**-SNAPSHOT";
    import java.base "7";
    import ceylon.interop.java "**NEW_VERSION**-SNAPSHOT";
    shared import java.jdbc "7";
    import ceylon.time "**NEW_VERSION**-SNAPSHOT";
    import ceylon.transaction "**NEW_VERSION**-SNAPSHOT";
}
