 ...
 ********************************************************************************/
"
 The __&lt;main&gt;__ represents the main content of the body of a document or 
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-main-element).
"
tagged("flow")
shared class Main(
    ...
    shared actual {Content<FlowCategory>*} children = [])
        extends Element("main", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
