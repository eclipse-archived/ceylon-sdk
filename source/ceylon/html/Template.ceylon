 ...
 ********************************************************************************/
"
 The __&lt;template&gt;__ element is a mechanism for holding client-side content 
 that is not to be rendered when a page is loaded but may subsequently be instantiated 
 during runtime using JavaScript. Think of a template as a content fragment that is 
 being stored for subsequent use in the document.
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-template-element).
"
...
shared class Template(
    ...
    shared actual {Content<MetadataCategory|FlowCategory>*} children = [])
        extends Element("template", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
