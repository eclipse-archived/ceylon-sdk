...
"Represents anything that you can read/write to, much like the UNIX notion of file descriptor.
 ...
 "
//TODO see (Socket, SelectableFileDescriptor)
...
shared interface FileDescriptor {
    ...
    "Reads data until the end of file is reached, in a blocking way, by passing it to
    ...
    "Writes the given buffer to this file descriptor entirely, until either the buffer
    ...
    "Writes all the data produced by the given producer to this file descriptor, until
