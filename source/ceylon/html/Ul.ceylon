 ...
 ********************************************************************************/
"
 The __&lt;ul&gt;__ element represents an unordered list of items, namely a collection 
 of items that do not have a numerical ordering, and their order in the list is meaningless. 
 Typically, unordered-list items are displayed with a bullet, which can be of 
 ...
 Ul {
     for(day in {\"Mon\", \"Tues\", \"Wed\", \"Th\", \"Fri\"})
         Li { day }
 };
 </pre>
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-ul-element).
"
tagged("flow", "lists")
see(`class Li`, `class Ol`)
shared class Ul(
    ...
    shared actual {Content<Li>*} children = [])
        extends Element("ul", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
