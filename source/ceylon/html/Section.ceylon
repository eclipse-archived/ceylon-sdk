 ...
 ********************************************************************************/
"
 The __&lt;section&gt;__ element represents a generic section of a document, 
 i.e., a thematic grouping of content, typically with a heading.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-section-element).
"
tagged("flow")
shared class Section(
    ...
    shared actual {Content<FlowCategory>*} children = [])
        extends Element("section", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
