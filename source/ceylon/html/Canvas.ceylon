 ...
 ********************************************************************************/
"
 The __&lt;canvas&gt;__ element can be used to draw graphics via scripting. 
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-canvas-element).
"
...
shared class Canvas(
    ...
    "Attribute specifies the height of the coordinate space in CSS pixels. Defaults to 150."
    Attribute<Integer> height = null,
    "Attribute specifies the width of the coordinate space in CSS pixels. Defaults to 300."
    Attribute<Integer> width = null,
    "The attributes associated with this element."
    Attributes attributes = [],
    "The children of this element."
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("canvas", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, 
