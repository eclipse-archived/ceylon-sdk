...
test void test_sun_jul_24_minus586_09_00_00_0000() => assertGregorianDateTime(-586, july, 24, sunday, !leapYear, 9 );
test void test_wed_dec_05_minus168_11_08_07_800() => assertGregorianDateTime(-168, december, 5, wednesday, leapYear, 11,8,7,800);
test void test_wed_sep_24_70_23_59_59_999() => assertGregorianDateTime(70, september, 24, wednesday, !leapYear, 23, 59, 59, 999);

test void test_mon_jan_01_1900_14_00_00_0000() => assertGregorianDateTime(1900, january, 1, monday, !leapYear, 14);
test void test_tue_oct_29_1974_02_01_03_0987() => assertGregorianDateTime(1974, october, 29, tuesday, !leapYear, 2,1,3,987);
test void test_mon_dec_13_1982_00_00_00_0001() => assertGregorianDateTime(1982, december, 13, monday, !leapYear, 0,0,0,1);
test void test_mon_dec_31_1999_00_00_01_0000() => assertGregorianDateTime(1999, december, 31, friday, !leapYear, 0,0,1,0);
test void test_mon_jan_01_2000_00_01_00_0000() => assertGregorianDateTime(2000, january, 1, saturday, leapYear, 0,1,0,0);
test void test_mon_jan_31_2000_01_00_00_0000() => assertGregorianDateTime(2000, january, 31, monday, leapYear, 1,0,0,0);
test void test_tue_feb_29_2000_10_10_10_0010() => assertGregorianDateTime(2000, february, 29, tuesday, leapYear, 10,10,10,10);
test void test_sun_dec_31_2000_23_59_59_9999() => assertGregorianDateTime(2000, december, 31, sunday, leapYear, 23,59,59,999);
test void test_wed_feb_29_2012_20_20_20_0020() => assertGregorianDateTime(2012, february, 29, wednesday, leapYear, 20,20,20,20);

test void testEqualsAndHashDateTime() {
...
test void testMinusHours_DateTime() {
...
test void testPlusMinutes_DateTime() {
...
test void testMinusMinutes_DateTime() {
    assertEquals( 15, data_1982_12_13_09_08_07_0050.plusMinutes(7).minutes);
...
test void testPlusSeconds_DateTime() {
...
test void testMinusSeconds_DateTime() {
    assertEquals( 15, data_1982_12_13_09_08_07_0050.plusMinutes(7).minutes);
...
test void testPlusMillis_DateTime() {
...
test void testMinusMilliseconds_DateTime() {
...
test void testWithDay40_DateTime() {
    try {
...
test void testWithDay0_DateTime() {
    try {
...
test void testWithDayNegative_DateTime() {
    try {
...
test void testWithDay29FebNotLeap_DateTime() {
    try {
...
test void testSuccessor_DateTime() {
    assertEquals{ 
...
test void testPeriodFrom_DateTime() {
...
test void testPeriodFrom_DateTimeNegative() {
    Period period = Period{ days = -2; hours = -14;};
...
test void testPeriodFromSameYearNoTime_DateTime() {
...
test void testPeriodFromSameYearNoTime_DateTimeNegative() {
    Period period = Period{ months = -8; days = -3;};
...
test void testPeriodFromSameYear_DateTime() {
...
test void testPeriodFromSameYear_DateTimeNegative() {
    Period period = Period{ months = -8; days = -2; hours = -23; minutes = -59; seconds = -59; milliseconds = -900;};
    DateTime from = dateTime(2013,october,31);
...
test void testPeriodFromMonthBeforeNoTime_DateTime() {
...
test void testPeriodFromMonthBeforeNoTime_DateTimeNegative() {
    Period period = Period{ years = -1; months = -10; days = -3;}; 
    DateTime from = dateTime(2013,october,31);
...
test void testPeriodFromMonthBefore_DateTime() {
...
test void testPeriodFromMonthBefore_DateTimeNegative() {
    Period period = Period{ years = -1; months = -10; days = -3; hours = -10; minutes = -30;}; 
...
test void testPeriodFromDayAfterNoTime_DateTime() {
...
test void testPeriodFromDayAfterNoTime_DateTimeNegative() {
    Period period = Period{ years = -2; days = -3;}; 
    DateTime from = dateTime(2013,december,31);
    DateTime to = dateTime(2011, december, 28);
    assertFromToDateTime(period, from, to);
...
test void testPeriodFromDayAfter_DateTime() {
...
test void testPeriodFromDayAfter_DateTimeNegative() {
    Period period = Period{ years = -2; days = -3; milliseconds = -999;}; 
...
test void testPeriodFromDayBeforeNoTime_DateTime() {
...
test void testPeriodFromDayBeforeNoTime_DateTimeNegative() {
    Period period = Period{ years = -1; months = -11; days = -20;};
...
test void testPeriodFromDayBefore_DateTime() {
    Period period = Period{ years = 1; months = 11; days = 20;};
...
test void testPeriodFromDayBefore_DateTimeNegative() {
    Period period = Period{ years = -1; months = -11; days = -20;};
...
test void testPeriodFromEqualDate_DateTime() {
...
test void testPeriodFromNewYearNoTime_DateTime() {
...
test void testPeriodFromNewYearNoTime_DateTimeNegative() {
    Period period = Period{ days = -4; };
...
test void testPeriodFromNewYear_DateTime() {
...
test void testPeriodNextStepByMs_DateTime() {
...
test void testPeriodPreviousStepByMs_DateTime() {
...
test void testEnumerableDateTime() {
...
test void testPeriodFromNewYear_DateTimeNegative() {
    Period period = Period{ 
        days = -3; 
        hours = -23; 
        minutes = -59; 
