 ...
 ********************************************************************************/
"
 The __&lt;thead&gt;__ element defines a set of rows defining the head 
 of the columns of the table.
 
 For example see [[table|Table]] element.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-thead-element).
"
see(`class Table`)
tagged("tables")
shared class THead(
    ...
    shared actual {Content<Tr>*} children = [])
        extends Element("thead", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children) {
}