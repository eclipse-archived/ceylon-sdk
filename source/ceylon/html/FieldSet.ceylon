 ...
 ********************************************************************************/
"
 The __&lt;fieldset&gt;__ element is used to group several controls as well as labels within a web form.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/document-metadata.html#the-fieldset-element).
 "
tagged("flow")
shared class FieldSet(
    ...
    "Attribute indicates that the form controls that are its descendants, except descendants of its first optional legend element, are disabled, i.e., not editable."
    Attribute<Boolean> disabled = null,
    "Attribute has the value of the id attribute of the form element its related to."
    Attribute<String> form = null,
    "Attribute represents the name of the field group."
    Attribute<String> name = null,
    "The attributes associated with this element."
    Attributes attributes = [],
    "The children of this element."
    shared actual {Content<Legend|FlowCategory>*} children = [])
        extends Element("fieldset", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, 
