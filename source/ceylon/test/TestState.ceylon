...
"A test state is _failure_, if it propagates an [[AssertionException]]."
shared object failure extends TestState("failure") {}

"A test state is _error_, if it propagates any exception which is not an [[AssertionException]]."
