 ...
 ********************************************************************************/
"
 The __&lt;dfn&gt;__ element represents the defining instance of a term. 
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-dfn-element).
"
see(`class Dl`)
...
shared class Dfn(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("dfn", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
