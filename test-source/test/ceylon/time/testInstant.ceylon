...
test void testDate() => assertEquals( date(2013, february, 13), feb_13_2013_18_00_42_0057.date(timeZone.utc) );
test void testTime() => assertEquals( time(18, 0, 42, 57), feb_13_2013_18_00_42_0057.time(timeZone.utc));

test void testPlusPeriod_UTC() {
