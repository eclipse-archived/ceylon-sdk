 ...
 ********************************************************************************/
"
 The __&lt;small&gt;__ element gives text strong importance, 
 and is typically displayed in bold.
 
 Technical details about this element can be found on the
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-strong-element).
"
...
shared class Strong(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("strong", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
