native("jvm")
module test.ceylon.http.server "1.3.2-SNAPSHOT" {
    import ceylon.test "1.3.2-SNAPSHOT";
    import ceylon.uri "1.3.2-SNAPSHOT";
    import ceylon.http.server "1.3.2-SNAPSHOT";
    import ceylon.http.client "1.3.2-SNAPSHOT";
    import ceylon.json "1.3.2-SNAPSHOT";
