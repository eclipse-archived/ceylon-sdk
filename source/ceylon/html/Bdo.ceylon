 ...
 ********************************************************************************/
"
 The __&lt;bdo&gt;__ element or HTML bidirectional override element is used to 
 ...
 [Official W3C reference](https://www.w3.org/TR/html5/grouping-content.html#the-bdo-element).
"
...
shared class Bdo(
    ...
    shared actual {Content<PhrasingCategory>*} children = [])
        extends Element("bdo", id, clazz, accessKey, contentEditable, contextMenu, dir, draggable, dropZone, hidden, lang, spellcheck, style, tabIndex, title, translate, attributes, children)
